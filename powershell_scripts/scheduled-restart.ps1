~\repos\UserScripts\powershell_scripts  main  ?6 ~1312 -6  bat.exe --style=grid .\schedule_restart.ps1 --paging=never --force-colorization --chop-long-lines --wrap=character
─────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
<#
.SYNOPSIS
...
─────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
~\repos\UserScripts\powershell_scripts  main  ?6 ~1312 -6  .\Schedule-Shutdown.ps1 -Time 300 -Unit seconds -Restart
.\Schedule-Shutdown.ps1: The term '.\Schedule-Shutdown.ps1' is not recognized as a name of a cmdlet, function, script file, or executable program.
Check the spelling of the name, or if a path was included, verify that the path is correct and try again.
~\repos\UserScripts\powershell_scripts  main  ?6 ~1312 -6 
