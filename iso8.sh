...
function ensure_extra_tools() {
  ...
  local need=(
    fzf lsof strace git gptfdisk bat fd reflector rsync
    neovim eza lsd python-rich python-rapidfuzz parted gparted
    adwaita-cursors alsa-lib apparmor appstream aspell at-spi2-core 
    audispd-plugins audispd-plugins-zos base-devel bash 
    bash-completion brltty-udev-generic btrfs-progs bzip2 cabextract 
    cairo ccid cdparanoia cdrkit cloud-guest-utils coreutils curl 
    cvs dav1d-doc db5.3 dconf debuginfod diffutils dosfstools e2fsprogs 
    easy-rsa efibootmgr espeak-ng evince exfatprogs exo f2fs-tools fftw 
    fish flex freeglut freetype2 fuse3 gawk gcr gd geoip2-database 
    git git-zsh-completion glib2-devel glibc glusterfs gnupg gnutls gpart 
    gptfdisk graphite-docs grep gtk3 gtkmm3 gvfs harfbuzz harfbuzz-utils 
    https icu imagemagick iptables jack java-runtime jfsutils kde-cli-tools 
    kguiaddons kwayland5 kwindowsystem less libarchive libbpf libevent libfido2 
    libheif libisoburn libmicrohttpd libopenraw libp11-kit libpcap libpulse 
    libpwquality libsecret libusb libutempter libwebp-utils libwmf libx11 libxau 
    libxaw libxfixes libxkbcommon-x11 libxt libxtst linux-firmware-nfp lsof 
    lua lvm2 lz4 lzop man mkinitcpio-nfs-utils mtools mypy nbd netctl 
    netpbm netplan networkmanager nilfs-utils nss-mdns ntfs-3g ocaml 
    opengl-man-pages openresolv openssh openssl org.freedesktop.secrets 
    os-prober ostra-cg p7zip pam pcmanfm pcsclite perl perl-authen-sasl 
    perl-cgi perl-crypt-passwdmd5 perl-digest-sha1 perl-file-homedir 
    perl-file-mimeinfo perl-io-socket-ssl perl-libwww perl-locale-gettext 
    perl-lwp-protocol-https perl-net-dbus perl-term-readkey perl-x11-protocol 
    polkit psutils pulse-native-provider pv python python-babel python-blinker 
    python-brotli python-brotlicffi python-chardet python-cryptography 
    python-dbus python-dnspython python-dotenv python-email-validator 
    python-fqdn python-gobject python-h2 python-hypothesis python-idna 
    python-isoduration python-jsonpointer python-linkify-it-py python-markdown 
    python-mdit_py_plugins python-passlib python-pip python-pipx python-pyjwt 
    python-pynvim python-pysocks python-rfc3339-validator python-rfc3987 
    python-setuptools python-systemd python-twisted python-uri-template 
    python-urllib3 python-webcolors python-zstandard qrencode qt5-x11extras 
    quota-tools refind-docs rpm-tools rrdtool rsync ruby s-nail samba sbsigntools 
    scx-scheds sdl sdl2 sh smtp-forwarder speech-dispatcher sqlite subversion 
    sudo systemd-sysvcompat systemd-ukify tcl tk tmux tpm2-abrmd tpm2-tss tree-sitter 
    udftools unace unarj unrar unzip usb_modeswitch util-linux vim wayland 
    which wireless-regdb wl-clipboard words x11-ssh-askpass xclip xfsprogs 
    xorg-xauth xorg-xhost xsel xz zip zsh
  )
