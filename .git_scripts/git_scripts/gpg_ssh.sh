...
# Function to select an existing GPG key
function select_gpg_key() {
    echo "Please select the GPG key to use for signing commits:"
    gpg --list-secret-keys --keyid-format=long

    echo "Enter the GPG key ID you'd like to use:"
    read -r GPG_KEY_ID
